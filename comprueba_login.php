...
<?php 
	...
	try {
		...
		$base = new PDO("mysql:host=tatosqlserver.mysql.database.azure.com; dbname=arnet", "tato", "Tapon_458", array (PDO::MYSQL_ATTR_SSL_CA => 'controlador/DigiCertGlobalRootCA.crt.pem' ));
